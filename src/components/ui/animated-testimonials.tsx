        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            <h3 className="text-2xl font-bold text-white">
             ...
             <motion.p className="mt-8 text-lg text-white/70">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/10 hover:bg-[var(--accent)] transition-colors"
            >
